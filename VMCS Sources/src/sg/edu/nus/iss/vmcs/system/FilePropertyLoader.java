...
public abstract class FilePropertyLoader implements PropertyLoader {
	...
	private LoadPropertyStrategy loadStrategy;
	...
	public void SetLoadPropertyStrategy(LoadPropertyStrategy loadStrategy){
	...
	public void initialize() throws IOException {
		this.prop = this.loadStrategy.loadProperties(fileName);
	}
	...
	public void saveProperty() throws IOException {
		this.loadStrategy.saveProperties(fileName, prop);
	}

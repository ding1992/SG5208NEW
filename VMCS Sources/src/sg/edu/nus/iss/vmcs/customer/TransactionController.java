...
public class TransactionController implements Observer {
	 ...
	 * coin entry is complete and the money received is sufficient to dispense the
	 * drink. The following actions are performed. <br>
	 ...
	 * to deactivate the Drink Selection Box and instruct the CoinReceiver to refund
	 * the money inserted by the customer.
	 */
	 ...
	 * <br>
	 * 2- If coin input is not yet complete, the CoinReceiver will be instructed to
	 * stop coin input and refund the money entered so far&#46; <br>
